...
| file | | |
|---|---|---|
| `tape-decode-full-gui-windows_1.0.0_x86_64.exe` | 104 MB | Windows · GUI, con el CLI dentro |
| `tape-decode-full-windows_1.0.0_x86_64.exe` | 58 MB | Windows · solo línea de comandos |
| `tape-decode-full-gui-linux_1.0.0_x86_64.zip` | 198 MB | Linux x86-64 · AppImage dentro del ZIP |
| `tape-decode-full-gui-linux_1.0.0_arm64.zip` | 138 MB | Linux arm64 · AppImage dentro del ZIP |
| `tape-decode-full-gui-macos_1.0.0_x86_64.dmg` | 97 MB | macOS Intel |
| `tape-decode-full-gui-macos_1.0.0_arm64.dmg` | 80 MB | macOS Apple Silicon |

The Windows build ships four x86-64 microarchitecture levels and picks the best
one your CPU supports. The macOS disk images are ad-hoc signed but not
notarized: the first time, open them with right click → Open.

El build de Windows lleva dentro cuatro niveles de microarquitectura x86-64 y
elige el mejor que soporte tu CPU. Los DMG de macOS llevan firma ad-hoc pero no
están notarizados: la primera vez, ábrelos con clic derecho → Abrir.
