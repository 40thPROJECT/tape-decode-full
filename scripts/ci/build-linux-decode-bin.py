...
def main() -> None:
    ...
    pyi_args: list[str] = [
        ...
        "--add-data",
        f"resources/icon/tape-decode-full-256.png{_platform_sep()}resources/icon/tape-decode-full-256.png",
        "--add-data",
        f"resources/icon/tape-decode-full-256.png{_platform_sep()}tape-decode-full-256.png",
        "--add-data",
        f"resources/icon/tape-decode-full-256.png{_platform_sep()}tape-decode-full-gui.png",
        "--icon",
        "resources/icon/tape-decode-full-256.png",
        "--onefile",
        "--name",
